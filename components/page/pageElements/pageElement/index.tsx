...
const PageElement: React.FC<IProps> = (props) => {
  ...
  const renderEl = () => {
    switch (pageElement.type) {
      case 'richTextElement':
        return (
          <PageElementRichText element={pageElement as IPageElementRichText} />
        )
      case 'imageElement':
        return <PageElementImage element={pageElement as IPageElementImage} />
      case 'galleryElement':
        return (
          <PageElementGallery element={pageElement as IPageElementGallery} />
        )
      case 'titleElement':
      ...
      case 'highlightedBooksElement':
        return (
          <PageElementHighlightedBooks
            element={pageElement as IPageElementHighlightedBooks}
            {...extraProps}
          />
        )
      case 'joinNewsletterElement':
        return (
          <PageElementJoinNewsletter
            element={pageElement as IPageElementJoinNewsletter}
          />
        )
      default:
        return null
  ...
  return <PageElementWrapper>{renderEl()}</PageElementWrapper>
}
