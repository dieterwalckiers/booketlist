...
function FilterFreeTextSearch({ searchString: searchStringProps, onUpdateSearchString }: Props) {

    const [searchString, setSearchString] = React.useState<string>(searchStringProps);
